...
export default function ServicePage() {
  ...
  useEffect(() => {
    getDocs(query(collection(db, "providers"), where("approved", "==", true), where("type", "==", "flowers"), orderBy("rating", "desc")))
  ...
  return (
    <div style={{ background: "#FAF7F2", minHeight: "100vh", paddingBottom: 90, fontFamily: "Tajawal, sans-serif", direction: "rtl" }}>
      <div style={{ background: "#fff", padding: "52px 20px 16px", borderBottom: "1px solid #E8DDD0" }}>
        ...
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: "#2C1A0A", textAlign: "center" }}>{LABELS["flowers"] || "flowers"}</div>
      </div>
